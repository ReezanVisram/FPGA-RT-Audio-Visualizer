...
## LEDs
set_property -dict { PACKAGE_PIN E18   IOSTANDARD LVCMOS33 } [get_ports { test_led }]; #IO_L16N_T2_A27_15 Sch=led[2]
...
## Buttons
# set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { aresetn }]; #IO_L18N_T2_A23_15 Sch=btn[0]
...
## Pmod Header JA
# set_property -dict { PACKAGE_PIN L17   IOSTANDARD LVCMOS33 } [get_ports { line_out_mclk }]; #IO_L4P_T0_D04_14 Sch=ja_p[1]
# set_property -dict { PACKAGE_PIN L18   IOSTANDARD LVCMOS33 } [get_ports { line_out_ws }]; #IO_L4N_T0_D05_14 Sch=ja_n[1]
# set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { line_out_sck }]; #IO_L5P_T0_D06_14 Sch=ja_p[2]
# set_property -dict { PACKAGE_PIN N14   IOSTANDARD LVCMOS33 } [get_ports { line_out_sdin }]; #IO_L5N_T0_D07_14 Sch=ja_n[2]
# set_property -dict { PACKAGE_PIN M16   IOSTANDARD LVCMOS33 } [get_ports { line_in_mclk }]; #IO_L7P_T1_D09_14 Sch=ja_p[3]
# set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { line_in_ws }]; #IO_L7N_T1_D10_14 Sch=ja_n[3]
# set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { line_in_sck }]; #IO_L8P_T1_D11_14 Sch=ja_p[4]
# set_property -dict { PACKAGE_PIN N18   IOSTANDARD LVCMOS33 } [get_ports { line_in_sdout }]; #IO_L8N_T1_D12_14 Sch=ja_n[4]
...
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { line_out_ws }]; #IO_L18N_T2_A11_D27_14 Sch=jc2/ck_io[40]
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { line_out_sck }]; #IO_L15P_T2_DQS_RDWR_B_14 Sch=jc3/ck_io[39]
set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports { line_out_sdin }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 Sch=jc4/ck_io[38]
set_property -dict { PACKAGE_PIN U16   IOSTANDARD LVCMOS33 } [get_ports { line_in_mclk }]; #IO_L16P_T2_CSI_B_14 Sch=jc7/ck_io[37]
set_property -dict { PACKAGE_PIN P13   IOSTANDARD LVCMOS33 } [get_ports { line_in_ws }]; #IO_L19P_T3_A10_D26_14 Sch=jc8/ck_io[36]
set_property -dict { PACKAGE_PIN R13   IOSTANDARD LVCMOS33 } [get_ports { line_in_sck }]; #IO_L19N_T3_A09_D25_VREF_14 Sch=jc9/ck_io[35]
set_property -dict { PACKAGE_PIN V14   IOSTANDARD LVCMOS33 } [get_ports { line_in_sdout }]; #IO_L20P_T3_A08_D24_14 Sch=jc10/ck_io[34]
